								...
								<form method="post" action="login.do">
									...
									<div class="form-group">
										<label>Password</label> <input class="form-control"
											type="password" placeholder="This is case sensitive field">
									</div>
									<button type="submit" class="btn btn-default">Customer
										Login</button>
									<button type="submit" class="btn btn-default">Employee
										Login</button>
									<p>
